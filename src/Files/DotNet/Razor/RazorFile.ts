...
export class RazorFile extends FileBase {
    private constructor(
        ...
        super(absolutePath, filename, collapsibleState, FileBaseKind.razor, parent);
    ...
    public static async createAsync(absolutePath: string, filename: string, parent: FileBase): Promise<FileBase> {
        return new RazorFile(absolutePath, filename, vscode.TreeItemCollapsibleState.Collapsed, parent);
    }
