...
export class ProjectAnaylzerListFile extends FileBase {
    private constructor(
    ...
    public static async createAsync(absolutePath: string, filename: string, parent: FileBase): Promise<FileBase> {
        return new ProjectAnaylzerListFile(absolutePath, filename, vscode.TreeItemCollapsibleState.Collapsed, parent);
    }
