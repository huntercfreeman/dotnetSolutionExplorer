...
export class ProjectReferenceFile extends FileBase {
    private constructor(
        ...
        super(absolutePath, filename, collapsibleState, FileBaseKind.projectReference, parent);
    ...
    public static async createAsync(absolutePath: string, filename: string, parent: FileBase): Promise<FileBase> {
        return new ProjectReferenceFile(absolutePath, filename, vscode.TreeItemCollapsibleState.None, parent);
    }
    ...
    contextValue = "dotnet-solution-explorer.project-reference";
}
