...
/** 
 * Generally this class is used for '.txt' extensions however it
 * is also used when a file extension type is unrecognized. 
*/
export class DefaultFile extends FileBase {
    private constructor(
    ...
    public static async createAsync(absolutePath: string, filename: string, parent: FileBase): Promise<FileBase> {
        return new DefaultFile(absolutePath, filename, vscode.TreeItemCollapsibleState.None, parent);
    }
